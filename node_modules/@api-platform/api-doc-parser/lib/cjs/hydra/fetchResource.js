...
exports.default = (function (resourceUrl, options) {
    ...
    return (0, fetchJsonLd_1.default)(resourceUrl, Object.assign({ itemsPerPage: 0 }, options)).then(function (d) { return ({
        parameters: (0, lodash_get_1.default)(d, "body.hydra:search.hydra:mapping"),
    }); });
});

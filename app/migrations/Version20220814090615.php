 ...
 */
final class Version20220814090615 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product2 ADD CONSTRAINT FK_B2612B5C12469DE2 FOREIGN KEY (category_id) REFERENCES category2 (id)');
